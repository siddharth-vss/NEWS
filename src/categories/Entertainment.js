...
export default function Entertainment(props) {
    ...
    let capitalizeFirstLetter = (string) => {
     ...
     let start =useCallback( async ()=>{
        let url =await `https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=6c5ce318bb1d4e078e4048f5f2d2c29b&page=1&pageSize=100` ;
    ...
    useEffect(() => {
        document.title = `${capitalizeFirstLetter('entertainment')} - NewsMonkey`;
        start(); 
